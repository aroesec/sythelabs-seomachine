# Sythe Labs Style Guide

This guide defines writing conventions, formatting standards, and editorial guidelines for all Sythe Labs content.

## Instructions
Fill in this template with Sythe Labs-specific style preferences. Update as the style guide evolves.
...
- [x] Sentence case (Only capitalize first word)
- **Decision**: [Choose one and document here]

**Product Names**:
- Sythe Labs: [Always capitalized]
- Managed Security Services Provider: [Always capitalized]
- MSSP: [Always capitalized]
- Penetration Testing: [Always capitalized]
- Red Team: [Always capitalized]
...
- attack simulation
- breach simulation
- social engineering (use carefully)
...
- Please do not ever use emdashes EVER
...
- Example: "Your RSS feed URL is `https://sythelabs.com/...`"
...
- Include "| Sythe Labs" if space allows
...
This style guide is a living document. Update as Sythe Labs brand and voice evolve.
